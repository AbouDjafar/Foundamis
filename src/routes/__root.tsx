...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "École biblique Foundation and Mission School : formation chrétienne, mission et discipulat. Présentiel et en ligne, Français & Anglais." },
      { name: "author", content: "Foundation and Mission School" },
      { property: "og:site_name", content: "Foundation and Mission School" },
    ...
    scripts: [{
      ...
      children: JSON.stringify({
        ...
        name: "Foundation and Mission School",
