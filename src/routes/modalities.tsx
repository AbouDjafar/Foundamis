    ...
    <>
      <section className="relative overflow-hidden bg-gradient-cover-dark bg-world-map py-20 text-[#10284d] md:py-28">
        ...
        <div className="relative container mx-auto max-w-3xl px-4 text-center md:px-6">
          <p className="text-xs font-semibold uppercase tracking-[0.25em] text-[#10284d]">Modalités & Tarifs</p>
          <h1 className="mt-4 font-serif text-4xl font-semibold md:text-6xl">Choisissez votre format</h1>
      ...
      <section className="container mx-auto px-4 py-20 md:px-6">
        <div className="grid gap-6 md:grid-cols-2">
          {[
            ...
            <Card key={f.title} className="overflow-hidden border-border/60 transition-all hover:border-gold/40 hover:shadow-elegant">
              ...
              <div className="p-8 pt-6">
                ...
                <ul className="mt-6 space-y-2">
                  {f.features.map((t) => (
                    <li key={t} className="flex gap-3 text-sm"><Check className="h-5 w-5 shrink-0 text-gold" /><span>{t}</span></li>
                  ))}
                </ul>
              </div>
            </Card>
      ...
      <section className="relative overflow-hidden bg-gradient-soft py-20">
        ...
        <div className="container mx-auto max-w-4xl px-4 md:px-6">
          <div className="text-center">
            <p className="text-xs font-semibold uppercase tracking-[0.25em] text-gold">Tarifs</p>
            <h2 className="mt-3 text-3xl font-semibold md:text-5xl">Une formation accessible</h2>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            <Card className="border-border/60 p-7">
            ...
            <Card className="border-border/60 p-7">
              ...
              <p className="mt-4 text-xs text-muted-foreground">Couvre les 8 modules répartis en 2 cycles.</p>
            </Card>
            <Card className="bg-gradient-to-br from-card to-accent/30 p-7 shadow-elegant border-gold/40">
